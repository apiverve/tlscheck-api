...
```gradle
dependencies {
    implementation 'com.github.apiverve:tlscheck-api:1.1.13'
}
```
...
```java
import com.apiverve.tlscheck.TLSCheckerAPIClient;
import com.apiverve.tlscheck.APIResponse;
import com.apiverve.tlscheck.APIException;

// Initialize the client
TLSCheckerAPIClient client = new TLSCheckerAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("domain", "amazon.com");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/tlscheck](https://docs.apiverve.com/ref/tlscheck)
...
- **Documentation:** [https://docs.apiverve.com/ref/tlscheck](https://docs.apiverve.com/ref/tlscheck)
- **Issues:** [GitHub Issues](https://github.com/apiverve/tlscheck-api/issues)
