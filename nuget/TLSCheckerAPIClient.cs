...
namespace APIVerve.API.TLSChecker
{
    ...
    /// <summary>
    /// Client for the TLSChecker API
    /// </summary>
    public class TLSCheckerAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/tlscheck";
        ...
        private static readonly Dictionary<string, ValidationRule> _validationRules = new Dictionary<string, ValidationRule>
        {
            ...
            { "port", new ValidationRule { Type = "integer", Required = false, Min = 1, Max = 65535 } }
        };
        ...
        public TLSCheckerAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public TLSCheckerAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public TLSCheckerAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, TLSCheckerQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(TLSCheckerQueryOptions options)
        {
        ...
        public ResponseObj Execute(TLSCheckerQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(TLSCheckerQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(TLSCheckerQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(TLSCheckerQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(TLSCheckerQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(TLSCheckerQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(TLSCheckerQueryOptions options)
        {
