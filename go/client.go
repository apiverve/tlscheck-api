...
const (
	baseURL        = "https://api.apiverve.com/v1/tlscheck"
	defaultTimeout = 30 * time.Second
)

// Client is the TLS Checker API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new TLS Checker API client.
...
// Execute makes a request to the TLS Checker API with typed parameters.
//
