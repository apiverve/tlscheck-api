// Package tlscheck provides a Go client for the TLS Checker API.
//
// For more information, visit: https://apiverve.com/marketplace/tlscheck?utm_source=go&utm_medium=readme
package tlscheck
...
// Request contains the parameters for the TLS Checker API.
//
// Parameters:
//   - domain (required): string - The domain to check the TLS/SSL configuration for
//   - port: integer - The port to connect to (usually 443 for HTTPS) [min: 1, max: 65535]
type Request struct {
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		...
		"port": {Type: "integer", Required: false, Min: float64Ptr(1), Max: float64Ptr(65535)},
	}
...
// ResponseData contains the data returned by the TLS Checker API.
type ResponseData struct {
	Domain string `json:"domain"`
	TlsVersions TlsVersionsData `json:"tlsVersions"`
}

// TlsVersionsData represents the tlsVersions object.
type TlsVersionsData struct {
	TLSv1 bool `json:"TLSv1"`
	TLSv1.1 bool `json:"TLSv1.1"`
	TLSv1.2 bool `json:"TLSv1.2"`
	TLSv1.3 bool `json:"TLSv1.3"`
}
