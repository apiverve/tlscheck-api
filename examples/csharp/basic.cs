    ...
    class TLSCheckerExample
    {
        ...
        static async Task<JsonDocument> CallTLSCheckerAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;domain&quot;] &#x3D; &quot;amazon.com&quot;, [&quot;port&quot;] &#x3D; 443 };
        ...
        {
            Console.WriteLine("📤 Calling TLS Checker API...\n");

            var result = await CallTLSCheckerAPI();
